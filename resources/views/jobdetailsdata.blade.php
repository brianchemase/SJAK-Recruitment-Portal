...
<head>
    <meta charset="utf-8">
    <title>Job Description - {{$JobTitle}}</title>
    ...
    <link href="{{asset('details/lib/animate/animate.min.css')}}" rel="stylesheet">
    <link href="{{asset('details/lib/owlcarousel/assets/owl.carousel.min.css')}}" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{asset('details/css/bootstrap.min.css')}}" rel="stylesheet">
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Job Detail - {{$JobTitle}}</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb text-uppercase">
                        <li class="breadcrumb-item"><a href="/">Home</a></li>
                       
                        <li class="breadcrumb-item text-white active" aria-current="page">{{$JobTitle}}</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="row gy-5 gx-4">
                    <div class="col-lg-8">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="text-start ps-4">
                                ...
                                <span class="text-truncate me-3"><i class="fa fa-map-marker-alt text-primary me-2"></i>Job Location : {{$JobLocation}}</span>
                    ...
                    <div class="col-lg-4">
                        <div class="bg-light rounded p-5 mb-4 wow slideInUp" data-wow-delay="0.1s">
                            ...
                            <p><i class="fa fa-angle-right text-primary me-2"></i>Published On: {{$PublishedOn}}</p>
                            <p><i class="fa fa-angle-right text-primary me-2"></i>Vacancy: {{$Vacancy}} Position(s)</p>
                            <p><i class="fa fa-angle-right text-primary me-2"></i>Job Nature: {{$JobNature}} Full Time</p>
                            ...
                            <p class="m-0"><i class="fa fa-angle-right text-primary me-2"></i>Date Line: {{$Deadline}}</p>
                        </div>
    ...
    <script src="{{asset('details/lib/wow/wow.min.js')}}"></script>
    <script src="{{asset('details/lib/easing/easing.min.js')}}"></script>
    <script src="{{asset('details/lib/waypoints/waypoints.min.js')}}"></script>
